                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-neigh-create')}}" method="POST">
                        {{csrf_field()}}
                          ...
                          <div class="col-lg-7">
                              <select id="cat" required="">
                                  <option value="">{{ __('Select Country') }}</option>
                                    @foreach($cats as $cat)
                                      <option data-href="{{ route('admin-city-load',$cat->id) }}" value="{{ $cat->id }}">{{ $cat->country_name }}</option>
                                    @endforeach
                                </select>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select id="subcat" name="city_id" required="" disabled=""></select>
                          </div>
                        </div>
